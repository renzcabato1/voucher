    ...
    <div class="row">
        ...
        <div class="ibox float-e-margins">
            ...
            <tbody>
                ...
                <tr>
                    <td> 
                        <button class="btn btn-sm btn-info" data-target="#edit_data{{$request->id}}" title='EDIT' data-toggle="modal" ><i class="fa fa-edit"></i></button>
                       
                        <a href="{{ url('/voucher-print/'.$request->id.'') }}" title='PRINT' target='_blank'> <button class="btn btn-sm btn-warning"  ><i class="fa fa-print"></i></button>
                        </a>
